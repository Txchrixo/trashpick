...
import 'controllers/admin_picker_history_controller.dart';

class AdminPickerHistoryScreen extends StatelessWidget {
  const AdminPickerHistoryScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(AdminPickerHistoryController());

    return Scaffold(
      appBar: AppBar(
        title: Obx(() => Text(
              controller.picker.value != null
                  ? 'Historique - ${controller.picker.value!.name}'
                  : 'Historique Picker',
            )),
      ...
      body: Obx(() {
        ...
        if (controller.picker.value == null) {
          return const Center(child: Text('Picker introuvable'));
        }
        ...
        return ListView(
          ...
          children: [
            ...
            Text(
              'Historique des collectes complétées',
              style: AppTextStyles.h4.copyWith(
                fontWeight: FontWeight.bold,
              ),
            ),
  ...
  Widget _buildDateFilters(
      AdminPickerHistoryController controller, BuildContext context) {
  ...
  Widget _buildRequestCard(
      TrashReport request, AdminPickerHistoryController controller) {
